...
if (commentsCount.length && location.hostname === 'yindongliang.com'){
  disqusShortName = "yindongliang";
  disqusPublicKey = "CRyWhnVfFiwNkBQafPmu1pKgg8eHpDc688BoHFcUA6Rgh984qX7IFB8Z7VVf4Brw";
}
...
window.onload = function(){
  ...
  if (/^#disqus|^#comment/.test(location.hash)){
    showComments();
  }else if (commentsCount.length && location.hostname === 'yindongliang.com'){
    disqusCount();
  }
}
